...
import styles from "./contest-import-modal.module.css";
import { useToast } from "./toast-context";

interface ContestImportModalProps {
  open: boolean;
  onClose: () => void;
}
...
export function ContestImportModal({ open, onClose }: ContestImportModalProps) {
  ...
  function handleConfirm() {
    // TODO: nối API thật — POST /api/contests/import (multipart/form-data, field "file")
    // sau khi backend đọc xong file zip, hiện kết quả (số cuộc thi/bài tập được tạo).
    ...
    <div className={styles.backdrop} onClick={handleClose}>
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        <div className={styles.header}>
          <h2>Import cuộc thi từ file ZIP</h2>
