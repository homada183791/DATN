...
export function LoginModal({
  ...
  function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    const success = login(identifier.trim(), password, role);
    if (!success) {
      ...
      >
        ...
        <form className={styles.form} onSubmit={handleSubmit}>
          ...
          <div className={styles.roleGroup}>
            <span className={styles.label}>Đăng nhập với vai trò</span>
            <div className={styles.roleSwitch}>
              ...
              <button
                type="button"
                className={`${styles.roleOption} ${role === "instructor" ? styles.roleOptionActive : ""}`}
