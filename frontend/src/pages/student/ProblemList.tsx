...
export default function ProblemList() {
  ...
  return (
    <div className="space-y-6 text-[#191919]">
      ...
      {/* ===== contribute modal ===== */}
      {showContribute && hasDocument && createPortal((
        <div className="fixed inset-0 bg-black/75 backdrop-blur-[2px] z-[90] flex items-center justify-center p-4" onClick={() => setShowContribute(false)}>
