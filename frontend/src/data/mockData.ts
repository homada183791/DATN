// Mock data for the JudgeHub application
...
export const contests: Contest[] = [
  { id: 'C001', title: 'Kỳ thi Giải thuật 2025 - Vòng 1', description: 'Kỳ thi vòng loại giải thuật năm 2025. Gồm các bài toán cơ bản về mảng, chuỗi và sắp xếp.', startTime: '2025-02-01 09:00', endTime: '2025-02-01 12:00', status: 'upcoming', participantCount: 156, problemCount: 5, type: 'ICPC' },
  { id: 'C002', title: 'Luyện tập Đồ thị', description: 'Bài tập về các thuật toán đồ thị cơ bản: BFS, DFS, Dijkstra.', startTime: '2025-01-20 14:00', endTime: '2025-01-20 17:00', status: 'running', participantCount: 89, problemCount: 4, type: 'OI' },
  { id: 'C003', title: 'Kỳ thi Giải thuật 2024 - Vòng chung kết', description: 'Vòng chung kết kỳ thi giải thuật 2024.', startTime: '2024-12-15 09:00', endTime: '2024-12-15 14:00', status: 'ended', participantCount: 45, problemCount: 8, type: 'ICPC' },
  { id: 'C004', title: 'Thi giữa kỳ - Cấu trúc dữ liệu', description: 'Bài thi giữa kỳ môn Cấu trúc dữ liệu và Giải thuật.', startTime: '2025-01-10 08:00', endTime: '2025-01-10 10:00', status: 'ended', participantCount: 67, problemCount: 3, type: 'Homework', classId: 'CL001', className: 'CTDL&GT - INT1009' },
  { id: 'C005', title: 'Luyện tập Quy hoạch động', description: 'Các bài tập về quy hoạch động từ cơ bản đến nâng cao.', startTime: '2025-02-10 14:00', endTime: '2025-02-10 18:00', status: 'upcoming', participantCount: 34, problemCount: 6, type: 'OI' },
  { id: 'C006', title: 'Thi cuối kỳ - Cấu trúc dữ liệu', description: 'Bài thi cuối kỳ môn Cấu trúc dữ liệu và Giải thuật.', startTime: '2025-01-25 08:00', endTime: '2025-01-25 11:00', status: 'running', participantCount: 72, problemCount: 5, type: 'Homework', classId: 'CL001', className: 'CTDL&GT - INT1009' },
];
