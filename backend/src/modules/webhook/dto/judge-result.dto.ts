...
export class TestResultItemDto {
  ...
  @ApiProperty({
    ...
    description: 'Trạng thái testcase',
...
export class JudgeResultDto {
  @ApiPropertyOptional({
    description: 'Cờ nhận biết đây là Custom Run (không lưu DB)',
    example: false,
  })
  @IsBoolean()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Session ID của Custom Run (chỉ có khi is_custom=true)',
  ...
  @ApiPropertyOptional({
    description: 'Mã bài nộp (UUID) - chỉ có khi is_custom=false',
    example: '123e4567-e89b-12d3-a456-426614174000',
  })
  @ValidateIf((o: any) => !o.is_custom)
  @IsUUID(undefined, {
  ...
  @ApiProperty({
    enum: SubmissionStatus,
    description: 'Trạng thái tổng quát của bài nộp',
    example: SubmissionStatus.ACCEPTED,
  })
  ...
  @ApiPropertyOptional({
    description: 'Thời gian chạy tổng (ms)',
    example: 150,
  })
  @IsInt({ message: 'Thời gian chạy phải là số nguyên (ms)' })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Bộ nhớ sử dụng lớn nhất (MB)',
    example: 12,
  })
  @IsInt({ message: 'Bộ nhớ sử dụng phải là số nguyên (MB)' })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Stdout (kết quả xuất ra) - chủ yếu dùng cho Custom Run',
    example: '8',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Stderr (thông báo lỗi) - chủ yếu dùng cho Custom Run',
    example: '',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    ...
    description: 'Mảng chi tiết kết quả từng testcase',
  })
  @IsArray()
